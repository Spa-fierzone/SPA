...
public class UserServiceImpl implements UserService {
    ...
    // Add missing methods for WorkScheduleWebController
    @Override
    public List<User> getAllStaff() {
        // Get all users with staff roles (excluding customers and admins)
        return userRepository.findByRoleNames(Arrays.asList("TECHNICIAN", "RECEPTIONIST", "MANAGER"));
    }
