...
""")
    ...
    @Query("SELECT a FROM Appointment a WHERE a.customer.userId = :customerId AND a.service.serviceId = :serviceId AND a.technician.userId = :technicianId AND a.branch.branchId = :branchId ORDER BY a.createdAt DESC")
